...
export const IconAngry = (p?: IconProps) => svg(iconProps(p), '<circle cx="12" cy="12" r="10"></circle><path d="M16 16s-1.5-2-4-2-4 2-4 2"></path><path d="M7.5 8 10 9"></path><path d="m16.5 8-2.5 1"></path><path d="M9 10h.01"></path><path d="M15 10h.01"></path>');
...
export const IconFilter = (p?: IconProps) => svg(iconProps(p), '<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon>');
